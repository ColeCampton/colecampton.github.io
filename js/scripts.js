$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            ...
            // Event Description
            description: "We can't wait to see you on our big day. For any queries or issues, please contact Cole and Kendall."
        }
    });
...
// Google map
function initMap() {
    var location = {lat: 36.4940231, lng: -121.7455798};
...
function initBBSRMap() {
    var la_fiesta = {lat: 36.4940231, lng: -121.7455798};
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 12,
        center: la_fiesta,
        scrollwheel: false
